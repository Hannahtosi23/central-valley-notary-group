Yes — paste this entire updated code into app/page.jsx:
...
export default function HomePage() {
  const Icon = ({ type }) => {
    const icons = {
      ...
      car: "M5 14l1.5-4.5h11L19 14 M5 14h14v4H5v-4z M7 18a1.5 1.5 0 1 0 0 .01 M17 18a1.5 1.5 0 1 0 0 .01",
      ...
      pin: "M12 21s7-5.5 7-11a7 7 0 1 0-14 0c0 5.5 7 11 7 11z M12 10a2 2 0 1 0 0 .01",
    ...
    return (
      <svg className="svg-icon" viewBox="0 0 24 24" fill="none">
        <path d={icons[type]} stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  };
  return (
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        h1 { font-size: clamp(62px, 8vw, 115px); line-height: .92; max-width: 900px; margin: 0 0 25px; letter-spacing: -2px; }
        h2 { font-size: clamp(38px, 5vw, 58px); margin: 0 0 20px; line-height: 1; }
        .gold { font-size: 28px; margin-bottom: 35px; }
        .line { width: 90px; height: 2px; background: #B7833A; margin-bottom: 35px; }
        .subtext { max-width: 650px; font-size: 22px; line-height: 1.7; margin-bottom: 45px; color: #333; }
        .buttons { display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 70px; }
        .btn {
          padding: 20px 32px;
          border-radius: 6px;
          text-transform: uppercase;
        ...
        .btn-light { background: rgba(255,255,255,.9); color: #8B5A20; border: 1px solid #B7833A; }
        .feature-bar {
          background: #090909;
          color: white;
          border-radius: 18px;
        ...
        .feature p { color: #d2d2d2; line-height: 1.6; font-size: 15px; margin: 0; }
        .svg-icon { width: 42px; height: 42px; color: #E8C27A; flex-shrink: 0; }
        section { padding: 100px 8%; }
        .center { max-width: 760px; margin: 0 auto 60px; text-align: center; }
        .section-label { font-size: 12px; margin-bottom: 20px; }
        ...
        .card .svg-icon { color: #B7833A; width: 54px; height: 54px; margin: 0 auto 24px; }
        .card h3 { font-size: 28px; margin-top: 0; margin-bottom: 18px; line-height: 1.1; }
        .card p { color: #555; line-height: 1.8; }
        .card-line { width: 52px; height: 2px; background: #B7833A; margin: 18px auto 24px; }
        .price { margin-top: 30px; text-transform: uppercase; letter-spacing: .15em; font-size: 12px; font-weight: 700; }
        .price span { font-size: 28px; letter-spacing: 0; }
        .trust {
          background: #050505;
          color: white;
          padding: 42px 8%;
        ...
        .trust .svg-icon { width: 34px; height: 34px; color: #E8C27A; }
        ...
        .doc .svg-icon { width: 24px; height: 24px; color: #B7833A; }
        ...
        .ready-list { display: grid; gap: 28px; margin-top: 28px; }
        .ready-item { display: flex; align-items: center; gap: 24px; color: #555; line-height: 1.7; font-size: 20px; }
        .circle-icon {
          width: 70px;
          height: 70px;
          border-radius: 50%;
        ...
        .circle-icon .svg-icon { width: 30px; height: 30px; color: #B7833A; }
        .faq { display: flex; flex-direction: column; gap: 22px; }
        .faq-item { background: white; border: 1px solid #ddd; border-radius: 8px; padding: 30px; }
        .faq-item h3 { margin-top: 0; font-size: 30px; margin-bottom: 12px; }
        .dark { background: #050505; color: white; }
        .dark p { color: #d0d0d0; }
        .contact-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 34px; }
        .contact-card { display: flex; gap: 22px; align-items: flex-start; }
        .contact-bubble {
          width: 68px;
          height: 68px;
          border-radius: 50%;
        ...
        .contact-bubble .svg-icon { width: 32px; height: 32px; color: #E8C27A; }
        .footer-note {
