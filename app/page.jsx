    ...
    <>
      ...
      <main>
        ...
        <section id="services">
          ...
          <div className="grid4">
            <div className="card"><Icon type="document" /><h3>Loan Signing Services</h3><div className="card-line"></div><p>Refinance packages, HELOCs, seller packages, buyer closings, and real estate loan documents.</p><div className="card-foot card-foot-nolink"><a className="card-link" href="/loan-signing-agent-fresno">See pricing and details &rarr;</a></div></div>
            <div className="card"><Icon type="users" /><h3>Trust & Estate Signings</h3><div className="card-line"></div><p>Living trusts, certifications of trust, powers of attorney, healthcare directives, and grant deeds.</p><div className="price">Starting at <span>$125</span></div><div className="card-foot"><div className="price-note">$15 per notarized signature, plus travel. Most trust packages run 6 to 12 signatures.</div><a className="card-link" href="/trust-signing-notary-fresno">See pricing and details &rarr;</a></div></div>
          ...
          <p className="pricing-note">
            <strong>California's notarization fee is $15 per notarized signature, plus travel.</strong> Each additional signature is $15, and a travel fee applies based on where we're traveling to. Jail notarizations start at the rate shown above, and loan signing pricing is on the loan signing page. You will always receive a clear, itemized quote before anything is signed.
          </p>
